...
class CheckoutControllerBK {
    ...
    public function calculate(){
      require_once(GLOBALSAX_PATH . '/db/ListaPrecios.php');
      require_once(GLOBALSAX_PATH . '/util/State.php');
...
$checkoutControllerBK = new CheckoutControllerBK();
?>
